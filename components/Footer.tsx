...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-green-50 to-green-200 pt-20 pb-6 overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center space-x-1 mb-10">
            ...
            <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Fast Delivery</span>
            <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-medium">Affordable</span>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-10 relative">
          <h3 className="font-bold text-gray-900 mb-6 text-center">
            <span className="bg-gradient-to-r from-green-500 to-blue-600 bg-clip-text text-transparent">OUR PAYMENT PARTNERS</span>
          </h3>
