...
export default function ContactPage() {
  ...
  const isInViewContactInfo = useInView(contactInfoRef, {
    once: true,
    amount: 0.3,
  });
  ...
  const openGoogleMaps = () => {
    window.open(
      `https://www.google.com/maps/place/DUA+PHARMACY,+Chanarthal+Rd,+near+New+Anaj+Mandi,+Thanesar,+Haryana+136118/@29.9516773,76.8391367,17z/data=!4m6!3m5!1s0x390e3b83dd0a5a13:0x8b2abc7cc9ceed3b!8m2!3d29.9517022!4d76.8392053!16s%2Fg%2F11wq0bj8_0?utm_campaign=ml-ardl&g_ep=Eg1tbF8yMDI1MDUxMl8wIJvbDyoASAJQAQ%3D%3D`,
      "_blank",
      "noopener,noreferrer"
    );
  };
    ...
    <div className="bg-gradient-to-r from-blue-200 to-red-100 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <motion.div
          ...
          animate={
            isInViewContactInfo ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }
          }
        ...
        >
          ...
          <motion.div
            ...
            animate={
              isInViewContactInfo ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
            }
...
"
                className="text-blue-600 hover:text-blue-700 block mb-2"
              >
                duapharmacy24@gmail.com
              </a>
              <a
                href="mailto:raghavdua720@gmail.com "
                className="text-blue-600 hover:text-blue-700 block mb-4"
              >
                raghavdua720@gmail.com
              </a>
          ...
          >
            <div className="p-8 card-content">
              ...
              <p className="text-gray-600 mb-1">
                Chanarthal Rd, near New Anaj Mandi
              </p>
        ...
        <div className="flex-container">
          ...
          <motion.div
            ...
            animate={
              isInViewForm ? { opacity: 1, x: 0 } : { opacity: 0, x: -50 }
            }
            transition={{ duration: 0.8 }}
          >
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600 text-sm">
                        Chanarthal Rd, near New Anaj Mandi, Thanesar, Haryana
                        136118
                      </p>
                    </div>
                  </div>
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600">
                We deliver medications from 10:00 AM to 8:00 PM every day except
                Sundays. For emergency deliveries, please call our helpline.
              </p>
            </div>

            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                Do you accept online prescriptions?
              </h3>
              <p className="text-gray-600">
                Yes, you can upload your prescription through our website or
                WhatsApp. Our pharmacist will verify it before processing your
                order.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600">
                We accept cash on delivery, credit/debit cards, UPI payments,
                and all major digital wallets for your convenience.
              </p>
            </div>

            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                Do you offer health consultations?
              </h3>
              <p className="text-gray-600">
                Yes, our qualified pharmacists can provide basic health
                consultations and medication guidance. For specialized advice,
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-8 md:mb-0 md:mr-8">
              ...
              <p className="text-gray-700 max-w-xl">
                Have an urgent medical need or question? Our team is available
                around the clock to assist you. Reach out to us through any of
